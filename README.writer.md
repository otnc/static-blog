...
- PNG はパレット量子化 (品質 55)、JPEG は mozjpeg (品質 65)、静止 WebP は品質 62 で再圧縮します。
- 長辺が **2560px** を超える画像はアスペクト比を保ったまま縮小します。
...
- PNG は品質 40、JPEG は品質 50、静止 WebP は品質 48 で再エンコードします。
- 長辺が **1920px** を超える画像はアスペクト比を保ったまま縮小します。
